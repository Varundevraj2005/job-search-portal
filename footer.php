...
<footer id="contactus" style="background-color: #272727;">
    <div class="container" style="width: 100%;">
				<div class="row justify-content-center">
                    ...
                    <a href="mailto: varundevraj206@gmail.com" style="color: #ffd6a5; padding-top: 50px; font-family:Comfortaa;"> CONTACT </a>
                    </p>
                    </div>
                ...
                <div class="row mt-5">
					<div class="col-md-12 text-center">
						<p class="copyrigt">
                        <a style="color: #9FA4A9; text-decoration: none;"> All rights reserved 2025 | Developped by </a> 
                        <a href="https://www.linkedin.com/in/varun-devraj-1201b4345/" style="color: #FDFFAC;">Varundevraj</a> 
                        <a style="color: #FDFFAC; text-decoration: none;">&</a> 
                        <a href="https://www.linkedin.com/in/raksha-b-kottari-421b95220" style="color: #FDFFAC;">Akash</a> 
					    </p>
					</div>
				</div>
    </div>
