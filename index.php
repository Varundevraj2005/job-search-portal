            ...
            <div class="floating-area">
             ...
             <!-- Texts in home page with heading and sub texts-->
                  <div class="animated slideInRight">
                   ...
                   <br> Find the job meant for you. <b style="color: #e9c46a">#jobvioit</b>
                            ...
                            if(isset($_GET['category']))
                             ...
                             ?>
                                ...
                                <div class="col-md-4 crd" style="margin: 20px; background-color:#257059; padding: 20px;">
                                    ...
                                    <!-- ------------------------------------------------------------------ -->
                                    <a href="applyJob.php?id=<?php echo $pid;?>" class="pull-right" style="font-family: 'Sora', sans-serif; color:#e9c46a;" ><h3><strong>Apply</strong></h3></a>
                                </div>
                            ...
                            <br><br> 
                               <div style="padding-top:10px; padding-right:30px;">
                                 ...
                                 <form>
                                     ...
                                     <div> 
                                        <select class="form-control" name='category' style="border-radius:20px;">
                                        <?php include "categoryOptions.php";?>
                                        </select><br>
                                           <input class=" btn-success pull-right mbbtn" type="submit" value="Search" style="border-radius:20px;"/>
                                     </div>
                            ...
                            <br><br> 
                                <div style="padding-top:10px; padding-right:30px;">
                                 <h3>Jobs By Industry</h3>  
                                  ...
                                  <form>
                                  <select class="form-control" name='industry' style="border-radius:20px;">
